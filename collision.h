...
class collision{
	public:
	static bool sphereplane(vector3d& sp,vector3d pn,vector3d p1,vector3d p2,vector3d p3,vector3d p4, float r, bool up=false);
	...
	// c: center, rd: ray direction, s: start point of ray
	static bool raysphere1(vector3d c, vector3d rd,vector3d s,float r,float* dist=NULL,vector3d* collpoint=NULL);
