...
void initskybox()
{
	skybox[SKY_LEFT]=loadTexture("Skybox_Left_512.bmp",1);
	skybox[SKY_BACK]=loadTexture("Skybox_Back_512.bmp",1);
	skybox[SKY_RIGHT]=loadTexture("Skybox_Right_512.bmp",1);
	skybox[SKY_FRONT]=loadTexture("Skybox_Front_512.bmp",1);
	skybox[SKY_TOP]=loadTexture("Skybox_Top_512.bmp",1);
	skybox[SKY_BOTTOM]=loadTexture("Skybox_Bottom_512.bmp",1);
}
...
unsigned int loadTexture(const char* name, int background)
{
